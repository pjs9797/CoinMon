...
class SignupVerificationNumberViewController: UIViewController, ReactorKit.View {
    var disposeBag = DisposeBag()
    let backButton = UIBarButtonItem(image: ImageManager.Arrow_Chevron_Left, style: .plain, target: nil, action: nil)
    let verificationNumberView = VerificationNumberView(flowState: EmailEntryFlow.Signup)
...
extension SignupVerificationNumberViewController {
