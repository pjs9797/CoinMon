...
class PurchaseFlow: Flow {
    ...
    func navigate(to step: Step) -> FlowContributors {
        ...
        case .presentToPurchaseViewController:
            return presentToPurchaseViewController()
        case .presentToSuccessSubscriptionViewController:
            return presentToSuccessSubscriptionViewController()
    ...
    private func presentToPurchaseViewController() -> FlowContributors {
    ...
    private func presentToSuccessSubscriptionViewController() -> FlowContributors {
        let reactor = SuccessSubscriptionReactor(purchaseUseCase: self.purchaseUseCase)
    ...
    private func navigateToSubscriptionManagementViewController() -> FlowContributors {
        let reactor = SubscriptionManagementReactor(purchaseUseCase: self.purchaseUseCase)
    ...
    private func presentToIsRealPopViewController() -> FlowContributors {
        let reactor = IsRealPopReactor(flowType: .atPurchase)
